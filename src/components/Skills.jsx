          ...
          <div className="flex mt-3 gap-8">
            <div className="flex flex-col gap-4">
              <div className="flex items-center gap-2">
                ...
                <div>
                  <p className="font-poppins text-white text-sm medium:text-[16px]">Html</p>
              ...
              <div className="flex items-center gap-2">
                <GoCheckCircleFill className="text-xl mb-3 text-beauty" />
                <div>
                  <p className="font-poppins text-white text-sm medium:text-[16px]">Css</p>
              ...
              <div className="flex items-center  gap-2">
                <GoCheckCircleFill className="text-xl mb-3 text-beauty" />
                <div>
                  <p className="font-poppins text-white text-sm medium:text-[16px]">Java Script</p>
                  <p className="font-poppins text-[10px] text-white/80 medium:text-[12px]">
                    Basic
                  </p>
                </div>
            ...
            <div className="flex flex-col gap-4">
              <div className="flex items-center  gap-2">
                <GoCheckCircleFill className="text-xl mb-3 text-beauty" />
                <div>
                  <p className="font-poppins text-white text-sm medium:text-[16px]">Tailwindcss</p>
                  <p className="font-poppins text-[10px] text-white/80 medium:text-[12px]">
                    intermediate
                  </p>
                </div>
              ...
              <div className="flex items-center  gap-2">
                <GoCheckCircleFill className="text-xl mb-3 text-beauty" />
                <div>
                  <p className="font-poppins text-white text-sm medium:text-[16px]">React js</p>
                  <p className="font-poppins text-[10px] text-white/80 medium:text-[12px]">
                    Basic
                  </p>
                </div>
              ...
              <div className="flex items-center  gap-2">
                <GoCheckCircleFill className="text-xl mb-3 text-beauty" />
                <div>
                  <p className="font-poppins text-white text-sm medium:text-[16px]">Git</p>
                  <p className="font-poppins text-[10px] text-white/80 medium:text-[12px]">
                    intermediate
                  </p>
                </div>
          ...
          <div className="flex mt-3 ">
            <div className="flex flex-col gap-4 mr-12 medium:mr-32">
              <div className="flex items-center gap-2">
                <GoCheckCircleFill className="text-xl mb-3 text-beauty" />
                <div>
                  <p className="font-poppins text-white text-sm medium:text-[16px]">Node js</p>
                  <p className="font-poppins text-[10px] text-white/80 medium:text-[12px]">
                    Basic
                  </p>
                </div>
            ...
            <div className="flex flex-col gap-4 medium:-ml-14">
              <div className="flex items-center  gap-2">
                <GoCheckCircleFill className="text-xl mb-3 text-beauty" />
                <div>
                  <p className="font-poppins text-white text-sm medium:text-[16px]">My Sql</p>
                  <p className="font-poppins text-[10px] text-white/80 medium:text-[12px]">
                    Basic
                  </p>
                </div>
